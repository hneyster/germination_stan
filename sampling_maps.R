...
clim_plot<-  ggplot(data=clim) + 
  ...
  xlab("Month")+theme(legend.position = "none")
...
p1<-plot_grid(us, eu, clim_plot,align="hv", ncol=3, labels='auto')
ggsave(filename = "sampling_sites.pdf",plot = p1, width = 8, height = 5, units="in","pdf")
